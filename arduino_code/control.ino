...
void play_cha(unsigned char Track)
{
  unsigned char play_cha[8] = {0xAA,0x16,0x03,0x00,0x00,0x09,Track,Track+0xAA+0x16+0x03+0x09};//0xB3=0xAA+0x07+0x02+0x00,即最后一位为校验和
   voiceserial.write(play_cha,8);
}
